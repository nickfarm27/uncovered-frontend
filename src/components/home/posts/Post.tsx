			...
			<div className="flex pb-4 self-start">
				...
				<div className="flex flex-col pl-3">
					...
					<p className="font-medium">
						I will rule China one day. Lorem ipsum dolor sit amet
						consectetur adipisicing elit. Itaque animi debitis
						veniam quod expedita inventore pariatur odit fugit, aut,
						fugiat sunt deserunt placeat voluptatum, dicta enim
						iure! Quia, culpa fugit.
					</p>
				</div>
			</div>
