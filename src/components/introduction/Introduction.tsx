...
const Introduction = (props: Props) => {
	return (
		<div>
			...
			<div className="flex justify-center  box-border bg-blue-300 h-screen ">

				<div className="flex items-center w-1/3  ">
					<h1 className="text-center leading-loose text-6xl font-bold text-white">Questions?! Look Here</h1>
				</div>
				...
				<div className="flex flex-col justify-center items-center w-2/3 py-8">
					...
					<div className="rounded-3xl box-border flex flex-col justify-center h-4/6 w-10/12 bg-white">
						<h1 className="text-blue-500 text-3xl text-justify p-8">
