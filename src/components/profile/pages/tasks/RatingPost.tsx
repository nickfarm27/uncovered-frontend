		...
		>
			...
			<div className="flex flex-col w-full mt-4 mb-4 justify-between">
				<h1 className="font-semibold text-justify mb-4">
					Please rate the involved verifiers from the following news
					tweet verification:{" "}
				</h1>
				<h1 className="font-medium text-justify">
					I’m so proud and happy for my friends over at OTV welcoming
					three more friends, Jodi John and Sydney as official
					members!!! It’s been a long time coming and couldn’t be
					happier for all of them☺️❤️🎉{" "}
				</h1>
			</div>
